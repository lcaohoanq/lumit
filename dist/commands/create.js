...
async function resolveCreateOptions(projectNameArg, options) {
...
async function resolveProjectName(projectNameArg) {
...
async function resolvePackageManager(packageManagerOption, interactive) {
...
async function resolveInstall(installOption, interactive) {
...
async function resolveGit(gitOption, interactive) {
...
async function resolveVisibility(options, github) {
    if (!github) {
        return "public";
    }
...
async function resolvePush(githubFlag, interactive) {
